...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("Normal", "none", "none", "none")
    call <SID>X("NonText", "none", "none", "none")
    ...
    call <SID>X("Comment", "828282", "", "") " grey_color
    call <SID>X("Visual", "FF8225", "", "") " grey_color
    call <SID>X("Constant", "D6BD98", "", "") " orange
    call <SID>X("Identifier", "D6BD98", "", "none") " light blue
    call <SID>X("Function", "677D6A", "", "bold") " brown
    call <SID>X("Define", "433D8B", "", "none") " light brown
    call <SID>X("Statement", "F2613F", "", "none") "
    call <SID>X("String", "A0937D", "", "") "dark green
    call <SID>X("PreProc", "AFC4DB", "", "") "
    call <SID>X("Type", "FF8225", "", "")
    call <SID>X("pmenu", "ffffff", "000000", "")
    call <SID>X("NonText", "b1b1b1b1", "", "")
    call <SID>X("Folded", "ffffff", "b1b1b1b1", "")
    call <SID>X("FoldColumn", "b1b1b1b1", "", "")
    call <SID>X("CursorLineSign", "b1b1b1b1", "", "")
    call <SID>X("Directory", "b1b1b1b1", "", "")
    call <SID>X("Special", "b1b1b1b1", "", "")
    call <SID>X("DiffText", "FF6500", "1E3E62", "")

    call <SID>X("Special", "DAEFA3", "", "")" light green
    "Underlined
